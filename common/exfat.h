...
static uint32_t exfat_set_fat(uint32_t, uint32_t);
static int exfat_set_fat_chain(struct exfat_fileinfo *, uint32_t);
...
static int exfat_check_cache(uint32_t);
static int exfat_get_cache(uint32_t);
static int exfat_load_extra_entry(void);
static int exfat_traverse_directory(uint32_t);
static int exfat_clean_cache(uint32_t);
